    ...
    <div class="radio">
      <label><input type="radio" name="optradio" value="21/28/35 ddl">21/28/35 ddl</label>
    </div>
        <div class="radio">
      <label><input type="radio" name="optradio" value="35 ddl">35 ddl</label>
    </div>
    <div class="radio">
      <label><input type="radio" name="optradio" value="21/35/42 ddl">21/35/42 ddl</label>
    </div>
        <div class="radio">
      <label><input type="radio" name="optradio" value="28/42 ddl">28/42 ddl</label>
    </div>
        <div class="radio">
